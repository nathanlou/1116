						...
						<div class="msg_con">
							...
							<div style="display: flex;height: 2.8rem;line-height: 2.8rem;border: 0.00rem solid #f4f4f4;">
								...
								<div style="display: flex;width: 50%;">
									...
									<div style="margin-left: 0.9375rem;">{{ rowData.lastTime | dateFilter("yyyy-mm-dd hh:mm:ss") }}</div>
								</div>
							</div>
						</div>
					</el-tab-pane>
                  ...
                  <div style="margin-left: 0.9375rem;">30</div> -->
									...
									<div style="margin-left: 0.9375rem;display: flex;">
										...
										<div v-for="(itemv,indexv) in deviceDataVals[item.jcqdz]" v-else :key="indexv">{{ itemv?itemv:'-' }}<span
											 v-if="indexv < deviceDataVals[item.jcqdz].length-1">-</span></div>
									</div>
								</div>
							</div>
						</div>
				...
				<el-tabs type="border-card">
                  ...
                  <div style="margin-left: 0.9375rem;">30</div> -->
						...
						<el-tabs v-model="activeName" type="border-card" @tab-click="handleClick">
							<el-tab-pane v-for="(week,indexWeek) in xwzDeviceDataList" :key="indexWeek" :label="numberToWeek(indexWeek+1)"
