  ...
  <div class="titles">
    <div class="screen">
      ...
      <span style="float: right;">
        ...
        <el-button class="btn" type="success" icon="el-icon-edit" size="mini" round @click="reminds()">批量提醒</el-button>
        <el-button class="btn" type="danger" icon="el-icon-edit" size="mini" round @click="renews()">批量续费</el-button>
      </span>
    </div>
    <div class="container_table">
      ...
      >
        ...
        <el-table-column label="操作" width="250" align="center" fixed="right">
          <template slot-scope="scope">
            <el-button class="btn" type="success" size="mini" round plain @click="remindsim(scope.$index, scope.row)">提醒</el-button>
            <el-button class="btn" type="danger" size="mini" round plain @click="renew(scope.$index, scope.row)">续费</el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-form ref="form" :model="form" label-width="90px">
        ...
        <el-form-item label="续费月份">
          <el-select v-model="form.money" placeholder="请选择">
            ...
            <el-option label="二个月" value="2" />
            <el-option label="三个月" value="3" />
            <el-option label="四个月" value="4" />
            <el-option label="五个月" value="5" />
    ...
    <el-dialog title="续费" :visible.sync="xfdialog" width="40%">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="xfdialog = false">取 消</el-button>
        <el-button type="primary" size="mini" @click="xfdialog = false">确 定</el-button>
      </span>
    </el-dialog>
    <!-- 续费 -->
    <!-- 提醒 -->
    <el-dialog title="提醒" :visible.sync="txdialog" width="40%">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" size="mini" @click="txdialog = false">发送通知</el-button>
      </span>
    </el-dialog>
    <!-- 提醒 -->
  </div>
