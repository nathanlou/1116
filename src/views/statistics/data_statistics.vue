<template>
  <div style="width: 95%;margin-left: 2.5%;">
    <div style="display: flex;width: 80%;">
      <div v-for="(item,index) in head_arr" :key="index" class="head_con" style="display: flex;">
        <div class="cp_img">
          <img :src="item.img">
        </div>
        <div>
    ...
    <div style="text-align: right;margin-right: 5%;color: gray;margin-top: 2%;">
      日期：
      <el-date-picker
        v-model="value1"
        type="daterange"
    ...
    <div class="enterpriseCard">
      <el-card v-for=" i in 10 " :key="i" class="box-card">
        <div style="display: flex;justify-content: space-between;">
          <el-button round size="small" style="background-color: #55C2DD;color: #FFFFFF;">正式企业&nbsp;|&nbsp;启用</el-button>
