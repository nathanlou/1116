<template>
  <div class="titles">
    <div class="screen">
      ...
      日期：
      <el-date-picker v-model="timevalue" value-format="yyyy-MM-dd" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" size="mini" class="selectDate" @change="changes" />
